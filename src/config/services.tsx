...
export const SERVICES: Record<ServiceKey, ServiceMeta> = {
  ...
  googleAds: {
    ...
    deliverables: [
      "$500/mo management fee (billed to client, goes to BUM)",
      "Recommended ad spend: $600/mo (goes directly to Google, not to BUM)",
      "Recommended total monthly investment: $1,100/mo",
      "No contract — cancel any time",
      "Recommended after website audit — current site likely needs to be rebuilt before ads will convert effectively",
      "Campaign builds for all new initiatives (seasonal, events, promos)",
      "Biweekly performance review meetings available",
    ],
    imageUrl: "",
  ...
  websiteCreation: {
    ...
    deliverables: [
      "Pages: Home, About Us, Menu",
      "JSON Schema markup + AEO (Answer Engine Optimization) — structured data that helps AI platforms like ChatGPT and Gemini find and recommend the restaurant, beyond standard Google SEO",
      "1 month build timeline",
      "3 rounds of revisions included",
      "No ongoing term — client keeps the website even if they stop working with BUM",
      "Integrates with existing reservation and online ordering systems",
    ],
    imageUrl: "",
  ...
  websiteManagement: {
    ...
    deliverables: [
      "New landing pages for Google Ads campaigns",
      "Ongoing edits and updates to existing pages",
      "$200/mo starting month 2 (after website is complete)",
      "Included at no extra charge during the 6-month bundle term",
    ],
    imageUrl:
